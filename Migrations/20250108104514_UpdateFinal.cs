        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousPasswordResetCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetSupplyCategories", x => x.SupplyCategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_PetSupplyCategories_SupplyCategoryId",
                        column: x => x.SupplyCategoryId,
                        principalTable: "PetSupplyCategories",
            ...
            migrationBuilder.InsertData(
                table: "PetSupplyCategories",
                columns: new[] { "SupplyCategoryId", "Name" },
                values: new object[,]
                {
                    { 1, "Đồ ăn" },
                    { 2, "Đồ chơi" },
                    { 3, "Phụ kiện chăm sóc và vệ sinh" },
                    { 4, "Sản phẩm làm đẹp và chăm sóc sức khỏe" },
                    { 5, "Dụng cụ vận chuyển và giải trí ngoài trời" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_SupplyCategoryId",
                table: "Products",
